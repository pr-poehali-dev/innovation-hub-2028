  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-6">
        <p className="md:text-base uppercase tracking-[0.4em] mb-6 opacity-80 text-[#000000] font-black text-xl">
        ...
        <p className="text-lg md:text-2xl mt-8 opacity-90 tracking-[0.2em] uppercase text-[#000000] font-black">
          1 августа 2026
        </p>
      </div>
    </div>
