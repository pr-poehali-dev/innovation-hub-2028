  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-6">
        <p className="md:text-base uppercase tracking-[0.4em] mb-6 opacity-80 font-normal text-xs text-[#ffffff]">
        ...
        <p className="md:text-2xl mt-8 opacity-90 tracking-[0.2em] uppercase font-normal text-sm text-[#ffffff]">
          1 августа 2026
        </p>
      </div>
    </div>
